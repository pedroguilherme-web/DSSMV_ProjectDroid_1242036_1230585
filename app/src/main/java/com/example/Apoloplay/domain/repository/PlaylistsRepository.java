...
public interface PlaylistsRepository {
    ...
    interface PlaylistsCallback { void onSuccess(List<Playlist> data); void onError(String message); }
    interface TracksCallback { void onSuccess(List<Music> data); void onError(String message); }
    interface PlaylistCallback { void onSuccess(Playlist playlist); void onError(String message); }
    interface SimpleCallback { void onSuccess(); void onError(String message); }
